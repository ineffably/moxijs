...
import { ThemeManager, createDefaultDarkTheme, createDefaultLightTheme, ThemeResolver } from './ui/theming';
...
import { UIRadioGroup } from './ui/components/ui-radio-group';
...
export type { BaseTheme, ThemeVariant, ThemeInfo, ThemeChangeListener, DefaultUITheme, ColorType, ControlType } from './ui/theming';
...
declare const exportedObjects: {
    ...
    ThemeResolver: typeof ThemeResolver;
    createDefaultDarkTheme: typeof createDefaultDarkTheme;
    createDefaultLightTheme: typeof createDefaultLightTheme;
    ...
    UICheckboxWithLabel: typeof UICheckboxWithLabel;
    UIRadioButton: typeof UIRadioButton;
    UIRadioGroup: typeof UIRadioGroup;
