...
export const DEFAULT_EDITOR_CONFIG: EditorConfig = {
  ...
  spriteSheets: {
    ...
    types: {
      'PICO-8': {
        name: 'PICO-8',
        description: '128x128 sprite sheet with 16-color palette',
        width: 128,
        height: 128,
        palette: [], // Will be populated from palettes.ts
        maxPerProject: 1,
        zoom: {
          default: 4,
          min: 1,
      ...
      'TIC-80': {
        name: 'TIC-80',
        description: '256x256 sprite sheet with 16-color palette',
        width: 256,
        height: 256,
        palette: [], // Will be populated from palettes.ts
        maxPerProject: 1,
  ...
  tools: {
    ...
    tools: {
      pencil: {
        id: 'pencil',
        name: 'Pencil',
        description: 'Draw individual pixels',
        icon: '', // Will be populated from tool-icons.ts
        cursor: 'crosshair',
        hotkey: 'p',
      },
      eraser: {
      ...
      eyedropper: {
        id: 'eyedropper',
        name: 'Eyedropper',
        description: 'Pick color from sprite',
        icon: '',
        cursor: 'crosshair',
        hotkey: 'i',
      },
  ...
  layouts: {
    ...
    layouts: {
      default: {
        id: 'default',
        name: 'Default Layout',
        description: 'Standard sprite editor layout',
        cards: {
          commander: {
            cardId: 'commander',
            anchor: 'top-left',
