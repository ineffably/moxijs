import { setupMoxi, asEntity, CameraLogic, asTextureFrames, TextureFrameSequences, SequenceInfo } from 'moxi';
import PIXI from 'pixi.js';
import { PlayerMovementLogic } from './player-movement-logic';
...
export const init = (async () => {
  ...
  // Convert to Moxi entity and add the movement logic
  ...
  // Initialize the logic with the sprite and textures
  ...
  // TODO: getLogic needs to be more convenient
  // TODO: prod builds: camera logic is missing or getLogic does not work.
