import { Logic, asEntity, loadFonts, setupMoxi } from 'moxi';
...
export const init = (async () => {
  ...
  const { scene, engine } = await setupMoxi({ hostElement });
  ...
  moxiProgressBar.moxiEntity.addLogic(
    new ProgressBarLogic({...defaultProgressBarOptions, ...barOptions } as ProgressBarOptions)
  );
