...
export { asPhysicsEntity, hasPhysics, getPhysicsBody, createShapeFromSprite } from './physics-utils';
export { PhysicsMaterials, applyMaterial } from './physics-materials';
export type { BodyType, SyncMode, ShapeType, CollisionTag, ShapeConfig, PhysicsWorldOptions, PhysicsBodyOptions, PhysicsDebugOptions, CollisionEvent, RaycastCallback } from './physics-types';
